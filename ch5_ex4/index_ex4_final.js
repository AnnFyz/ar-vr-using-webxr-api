...
function main() {
  ...
  // add spotlight for the shadows
  var robotarmSpotLight = new THREE.PointLight(0xffffff, 1, 100);
  robotarmSpotLight.position.set(seg3.position.x, lightHeight, seg3.position.z);
  //sphere.position.set(seg3.position.x, lightHeight, seg3.position.z); - to check position of the light
